...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    if self.green_light_alert:
      ...
      self.green_light = self.green_light_count >= 10 and self.previously_driving and (v_lead > 5 if have_lead else True) and not carState.gasPressed
    ...
    self.mpc.update(sm['radarState'], v_cruise, x, v, a, j, have_lead, self.aggressive_acceleration, self.increased_stopping_distance,
