...
FrogPilotControlsPanel::FrogPilotControlsPanel(QWidget *parent) : FrogPilotPanel(parent) {
  ...
  static const std::vector<std::tuple<QString, QString, QString, QString>> toggles = {
    ...
    {"VisionTurnControl", "Vision Turn Speed Control", "Automatically adjusts the vehicle's speed in accordance of the curvature of the road for smoother turning.", "../frogpilot/assets/offroad/icon_vtc.png"}
  };
...
FrogPilotVehiclesPanel::FrogPilotVehiclesPanel(QWidget *parent) : FrogPilotPanel(parent) {
  ...
  gmIconLabel->setPixmap(QPixmap("../frogpilot/assets/toggle_icons/icon_gm.png").scaledToWidth(80, Qt::SmoothTransformation));
  ...
  toyotaIconLabel->setPixmap(QPixmap("../frogpilot/assets/toggle_icons/icon_toyota.png").scaledToWidth(80, Qt::SmoothTransformation));
...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(QWidget *parent) : FrogPilotPanel(parent) {
  ...
  static const std::vector<std::tuple<QString, QString, QString, QString>> toggles = {
    ...
    {"RandomEvents", "Random Events", "A fun random mode that has a small chance of random events happening when certain conditions are met. i.e. Steering saturated event, braking too hard, fast acceleration, etc.", "../frogpilot/assets/offroad/icon_random.png"},
